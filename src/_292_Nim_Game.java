...
public class _292_Nim_Game {
	...
	public boolean canWinNim(int n) {
		/*
		 * Consider when n in 1-3, the first to go will win for sure
		 * 
		 * But for n=4, the first to go can only take up to 3, so lose for sure
		 * 
		 * for n in 5-7, the first to go can take 1-3 to convert to n=4
		 *
		 * And for n=8, the first to go can take 1-3 to convert to n in 5-7
		 * 
		 * So in this sense, any factor of 4 as the remaining will cause the
		 * lost of the first to go
		 */
		return n % 4 > 0;
	}
}
